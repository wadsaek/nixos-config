...
in
{
  ...
  bindel = [
    ", XF86AudioRaiseVolume, ${dispatchChangeVolume "5%+"}"
    ", XF86AudioLowerVolume, ${dispatchChangeVolume "5%-"}"
  ...
  bindl = [
    ...
    ", XF86AudioPrev, ${dispatchPrevSong}"
    ", XF86AudioNext, ${dispatchNextSong}"
  ];

  gesture = [
    "3, horizontal, workspace"
    "4, up, dispatcher, ${dispatchChangeVolume "1%+"}"
    "4, down, dispatcher, ${dispatchChangeVolume "1%-"}"
    "4, right, dispatcher, ${dispatchNextSong}"
    "4, left, dispatcher, ${dispatchPrevSong}"
  ];
}
