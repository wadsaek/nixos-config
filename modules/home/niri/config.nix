...
''
  ...
  // which may be more convenient to use. // See the binds section below for more spawn examples.
  spawn-at-startup "kitty" "--hold" "spotify_player"
  spawn-at-startup "kitty" "--hold" "fastfetch"
  ${lib.optionalString config.home.waybar.enable ''spawn-at-startup "waybar"''}
  ...
  binds {
      ...
      Mod+Shift+N {spawn "${pkgs.switchKanata}"; }
